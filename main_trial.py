...
# logo_path = r"C:\Users\Acer\Desktop\logo.jpeg"
...
<div class="nav-bar">
    ...
    <a class="nav-link" href="#Classification">Risks</a>
...
if menu_id == 'About':
    ...
    with col2:
        ...
        st.write("\n")
        st.write("\n")
        logo_path = r"C:\Users\Acer\Desktop\logo2.png"
        try:
        ...
        # Load and display the logo image
        logo_path = r"C:\Users\Acer\Desktop\image3.png"
        try:
            image = Image.open(logo_path)
            st.image(image, width=200)
        except FileNotFoundError:
...
if menu_id == "Classification":
    st.markdown("<h1 style='text-align: center; color: black;'>Claims Classification Tool<i class='bi bi-heart-fill' style='color: red;'></i></h2>", unsafe_allow_html=True)
    st.markdown("<hr style='border-top: 3px solid black;'>", unsafe_allow_html=True)
